...
int InitPose[23] = {2047, 1480, 2610, 1747, 2343, 2147, 1944, 2047, 2047, 2047, 2047, 2013, 2080, 2047, 2047, 2063, 2030, 2047, 2047, 2047, 2170, 2047, 2047};
		...
		if(id >= JointData::ID_R_SHOULDER_PITCH && id <= JointData::ID_HEAD_TILT)
		{
         ...
         if(AX12::isAX12(id))
         {
			   if(cm730->ReadByte(id, AX12::P_TORQUE_ENABLE, &value, 0) == CM730::SUCCESS)
			   {
				   ...
				   {
				       unsigned char table[50];
				       if(cm730->ReadTable(id, AX12::P_P_GAIN, AX12::P_PRESENT_POSITION_H, table, 0) == CM730::SUCCESS)
				       {
				           Step.position[id] = cm730->MakeWord(table[AX12::P_GOAL_POSITION_L], table[AX12::P_GOAL_POSITION_H]);
				           PresentPos.position[id] = cm730->MakeWord(table[AX12::P_PRESENT_POSITION_L], table[AX12::P_PRESENT_POSITION_H]);
				           P_Gain[id] = table[MX28::P_P_GAIN];
				           I_Gain[id] = table[MX28::P_I_GAIN];
				           D_Gain[id] = table[MX28::P_D_GAIN];
				       }
